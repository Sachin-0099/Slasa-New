...
const Experience = ({ExperienceData}) => {
  ...
  <span className="absolute left-0 bottom-0 w-full h-[4px] bg-gradient-to-r from-black via-[#3087D5] to-black"></span>
                            ...
                            <button className='lg:px-12 rounded-full lg:py-3 md:px-8 md:py-5 px-4 py-3 bg-gradient-to-b font-bold lg:text-xl md:text-xl text-sm from-[#000000] via-[#3087d1] to-[#000000] border border-outline-2 text-white flex items-center justify-center gap-3'>{data.button}</button>
                        </div>
                    </div>
