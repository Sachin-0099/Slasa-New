...
const OurStory = () => {
  ...
  return (
    <>
      <div className="bg-gray-100 py-12 px-6 sm:px-12 md:px-20">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 bg-white p-8 rounded-2xl shadow-lg">
          <div>
            <h3 className="text-[#3087d1] font-semibold text-xl sm:text-2xl">How It Started</h3>
          ...
          <div className="flex justify-center items-center">
            <div className="w-full sm:w-3/4 md:w-full h-[300px] sm:h-[350px] md:h-[400px]">
        ...
        <div className="mt-12 max-w-6xl mx-auto bg-white p-10 rounded-2xl shadow-lg">
          <Slider {...settings} className="w-full">
            <div className="text-center">
              <h2 className="text-3xl sm:text-4xl font-bold text-[#3087d1]">Our Vision</h2>
              <p className="text-gray-700 mt-4 text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="text-center">
              <h2 className="text-3xl sm:text-4xl font-bold text-[#3087d1]">Our Mission</h2>
              <p className="text-black mt-4 text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="text-center">
              <h2 className="text-3xl sm:text-4xl font-bold text-[#3087d1]">Core Values</h2>
              <p className="text-black mt-4 text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="text-center">
              <h2 className="text-3xl sm:text-4xl font-bold text-[#3087d1]">Mission Statement</h2>
              <p className="text-black mt-4 text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed">
