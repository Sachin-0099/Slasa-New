...
const EmptyCart = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white text-center px-4">
      ...
      <p className="text-xl text-gray-600 font-medium">{t("An empty shopping basket is a lonely shopping basket.")}</p>
      <p className="text-xl text-[#3087d1]">{t("Go on, add something!")}</p>
