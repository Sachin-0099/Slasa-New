      ...
      <nav className="navbar border  border-gray-500 bg-white p-2">
        <div className="flex justify-start space-x-4 py-2 overflow-x-auto no-scrollbar">
          ...
          <div className="flex-shrink-0 px-3 border-l-2  h-full">
            <a href="/acrylic" className="text-black text-base sm:text-sm">Acrylic Accessories</a>
          </div>
          {/* Category 2 */}
          <div className="flex-shrink-0 px-3 border-l-2 border-black h-full">
            <a href="/shop" className="text-black text-base sm:text-sm">Shop</a>
          </div>
          {/* Category 3 */}
          <div className="flex-shrink-0 px-3 border-l-2 border-black h-full">
            <a href="/photography" className="text-black text-base sm:text-sm">Photography & Videography</a>
          </div>
          {/* Category 4 */}
          <div className="flex-shrink-0 px-3 border-l-2 border-black h-full">
            <a href="others" className="text-black text-base sm:text-sm">Other Services</a>
          </div>
