...
import { EmadLogo } from '../Data/PhotoData';
const PrintSection = ({EditData}) => {
  return (
    ...
    <div className='min-h-[68vh] w-screen bg-blue-200 flex flex-col items-center justify-center py-10'>
        ...
        <span className={`hidden lg:inline-block absolute bottom-0 lg:w-[20vh] h-[4px] bg-gradient-to-b from-[#000000] via-[#3087D5] to-black mt-[10vh]`}></span>
            Print</h1>
            ...
            <div className='h-full lg:w-[70%] md:w-[70%] w-[90%] mt-5 flex gap-10 overflow-hidden overflow-x-auto items-center justify-around'>
                {EditData.map((photo,index)=>(
                    <div key={index}  className='lg:w-[40vh] flex flex-col items-center justify-center lg:h-[50vh] md:w-[40vh] md:h-[50vh] w-[30vh] h-[30vh] bg-white'>
                        ...
                        <h2 className='lg:text-xs md:text-xs text-xs text-center'>{photo.name}</h2>
        ...
        <button className='lg:px-10 lg:py-8 md:px-10 md:py-5 px-6 py-5 mt-10 bg-gradient-to-b font-bold lg:text-3xl md:text-2xl text-xl from-[#000000] via-[#3087d1] to-[#000000] border border-outline-2 text-white flex items-center justify-center gap-3'>Coming Soon
            <FaArrowRight/>
        </button>
    </div>
