...
export const VideoData = [
    { src: 'https://www.youtube.com/watch?v=iMbupzrIj2I' },
    { src: 'https://www.youtube.com/watch?v=qA3u1J3iFkU' },
    { src: 'https://www.youtube.com/watch?v=cpfbx0EFIbw' },
    { src: 'https://www.youtube.com/watch?v=awF6rcBEBJk' },
    { src: 'https://www.youtube.com/watch?v=cpfbx0EFIbw' },
    { src: 'https://www.youtube.com/watch?v=awF6rcBEBJk' }
  ];
...
export const GraphicsData = [
    { 
        src: '/Images/Graphics1.avif',
        name:'Blue Parrot',
        range:'$120-$130'  
     },
    {   src: '/Images/Graphics2.avif',
        name:'Fall Winter',
        range:'$120-$130'  
     },
    { 
        src: '/Images/Graphics3.avif',
        name:'Dreamy Swing',
        range:'$120-$130'
     },
]
